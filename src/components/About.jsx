        ...
        <section id={id} className="section-padding" style={{ position: 'relative' }}>
            <div className="container" style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(300px, 1fr))', gap: '4rem', alignItems: 'center' }}>
                ...
                <div className="animate-fade-in" style={{ opacity: 0, animationFillMode: 'forwards' }}>
                    ...
                    <a href="/resume.pdf" target="_blank" className="btn btn-outline" style={{ display: 'inline-flex', alignItems: 'center', gap: '0.75rem', borderColor: 'var(--primary)', color: 'var(--text-primary)' }}>
                        Download Resume
                    </a>
                </div>
